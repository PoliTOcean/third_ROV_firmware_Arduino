...
void printGyro()
{
  ...
  Serial.print(", ");
  Serial.print(imu.calcGyro(imu.gz), 2); //"{\"gx\":\"%f\",\"gy\":\"%f\",\"gz\":\"%f\"}"
  char packet[200];
  sprintf(packet, "{\"gx\":\"%f\",\"gy\":\"%f\",\"gz\":\"%f\"}\n");
  //String packet = "{\"gx\":\""+String(imu.calcGyro(imu.gx))+"\",\"gy\":\""+String(imu.calcGyro(imu.gy))+"\",\"gz\":\""+String(imu.calcGyro(imu.gz))+"\"}";
